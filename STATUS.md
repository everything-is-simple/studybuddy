...
| Frontend failure contract | implemented | `backend/tests/browser_frontend_failure_contract.spec.js` |
| Startup preflight | implemented | `backend/app/startup_preflight.py` and `backend/tests/test_startup_preflight.py` |
