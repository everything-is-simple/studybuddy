...
def test_b3_report_c0_documents_keep_c1_and_delivery_pending():
    ...
    assert "B3 C0 audit/scope, C1 Composer smoke, C2 isolated Integration, C3 Formal contract freeze, and C4 Formal focused implementation are complete" in status
    assert "下一步是 B3 C5 Formal backend/browser/source-lifecycle/backup-restore/operator acceptance" in todo
