...
function enterPhase9c(){document.querySelector('#phase9c').scrollIntoView({block:'start'});document.querySelector('#nav-phase9c').setAttribute('aria-current','page');['#nav-materials','#nav-qa','#nav-study','#nav-plans','#nav-notes'].forEach(selector=>document.querySelector(selector)?.setAttribute('aria-current','false'));refreshPhase9c()}
...
function enterNotes(){document.querySelector('#notes').scrollIntoView({block:'start'});document.querySelector('#nav-notes').setAttribute('aria-current','page');['#nav-materials','#nav-qa','#nav-study','#nav-plans'].forEach(selector=>document.querySelector(selector).setAttribute('aria-current','false'));refreshNotes()}
