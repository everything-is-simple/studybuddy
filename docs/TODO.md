...
- [ ] B4：QQ SMTP、飞书 Webhook 分别完成 Composer smoke -> Integration -> Formal dry-run/live 门禁；live 默认关闭、逐次确认、allowlist 和 explicit opt-in。B4 C3 Formal contract freeze 已完成：`docs/contracts/B4_DELIVERY_COMPONENT_CONTRACT.md`；脱敏证据：`docs/evidence/B4_DELIVERY_C3_CONTRACT_EVIDENCE.md`。Formal 行为未改变，live 仍关闭；C4 adapter/implementation、C5 acceptance、C6 closeout 待完成。
