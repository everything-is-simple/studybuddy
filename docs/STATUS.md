...
| Phase 7.2 embedding provider/config | implemented / backend-tested | versioned deterministic fake provider, independent registry, bounded batch/text/dimensions, environment config and safe capability extension are implemented; real network adapter, hybrid/fallback/Q&A integration remain incomplete |
