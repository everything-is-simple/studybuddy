...
| Phase 7.2–7.3 embedding foundation | implemented / backend-tested | versioned deterministic fake provider, independent registry/config, canonical identity, f32le_v1 codec, stale/source binding checks and ready-only vector filtering are implemented; real network adapter, rebuild/verify, hybrid/fallback/Q&A integration remain incomplete |
