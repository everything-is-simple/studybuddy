...
| Phase 7 embedding/retrieval | partial / backend-tested | v5 schema, fake embedding, payload codec, explicit fake indexing and vector-only cosine API are implemented; hybrid/fallback/real provider/Q&A integration remain incomplete; see `docs/PHASE7_1_AUDIT_AND_CONTRACT.md` |
