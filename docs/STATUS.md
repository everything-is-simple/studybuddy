...
| Phase 7.1 embedding/retrieval audit and contract freeze | implemented / documentation-reviewed; no schema change | `docs/PHASE7_1_AUDIT_AND_CONTRACT.md`; existing embeddings are reserved only, real retrieval remains lexical-only |
