...
- **Phase 9C：练习与反馈工作流（S3/S4/S5）**：整体仍为 `planned`，其中 9C-0/9C-1 已完成审计与契约冻结，9C-2..9C-7 已达到 `implemented/backend-pass`，9C-8 已达到 `browser-pass`。v11 migration/schema、共享 domain transaction、S3 PracticeRunner、S4 ErrorFixer、S5 ExamCrammer、最小安全 API 和 Chromium workspace 已覆盖 immutable snapshot、server deadline、submit/finish/expire/result、deterministic/pending grading、review/mistake facts、redo、cram goal/session、weak-point、append-only/idempotency、project scope、failure/reload/narrow/keyboard/privacy；source lifecycle、restore 和最终 acceptance 仍未完成，browser-pass 不推导 real-pass。范围是限时练习、错题改错/人工复核、期末冲刺，详见 [`phase9c/`](phase9c/)。
