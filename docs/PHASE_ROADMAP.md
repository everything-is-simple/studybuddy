...
**状态：进行中。** Phase 8.1 schema、8.2 Cards backend MVP 与 8.3 Exercises backend MVP 已完成 backend 验收；AI generation、Cards/Exercises UI/Chromium 和 Phase 8 总收口仍未完成。
...
- AI 卡片和练习 generation、UI/Chromium、人工简答复核和完整 Phase 8 closeout 尚未实现；不允许重新生成静默覆盖用户已编辑或已确认状态。
