...
Result: `2 skipped`. Its DeepSeek and Agnes tests require explicit provider/model/base URL/key gates and are not Phase 9B acceptance criteria. Separate P6-E provider evidence is maintained by `docs/../evidence/P6E_ACCEPTANCE_EVIDENCE.md`.
...
| B. Domain contract | **passed** | `../contracts/PHASE9B_DOMAIN_CONTRACT.md`; S1/S2 ownership, state transitions, citation/source lifecycle, export and restore boundaries are frozen |
