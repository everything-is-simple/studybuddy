...
>
> 审计与立项基线：[`PHASE9D_AUDIT_AND_SCOPE.md`](../archive/PHASE9D_AUDIT_AND_SCOPE.md)。9D-0 结论为**部分立项**：当前只冻结并允许实现 deterministic fake/loopback OCR/ASR、本地报告生成/预览/导出和 delivery dry-run；真实 OCR/ASR provider 与真实 SMTP/飞书生产外发暂不立项。
