...
**证据**: 原 A2.1 证据随历史规划资料移除；本归档仅保留总结和提交 provenance。
...
**证据**: 原 A2.2 证据随历史规划资料移除；本归档仅保留总结和提交 provenance。
...
**证据**: 原 A2.3 证据随历史规划资料移除；本归档仅保留总结和提交 provenance。
...
**证据**: 原 A2.4 证据随历史规划资料移除；本归档仅保留总结和提交 provenance。
...
A2.1–A2.4 的逐项证据和实施提示属于已移除的历史规划资料；可通过本文件列出的提交标识和 Git 历史追溯，不作为当前导航入口。
