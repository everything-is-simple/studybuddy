...
- [`phase9c/`](phase9c/)：Phase 9C S3/S4/S5 总规划、共用上下文、9C-0 至 9C-10 子任务、执行顺序和 Gate A-J；9C-2..9C-7 已达 `implemented/backend-pass`，9C-8 已达 `browser-pass`，Phase 9C 整体仍为 `planned`，目录中的 prompt/契约本身不是实现证据。
