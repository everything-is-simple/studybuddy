...
产出一份 docs/prompts/phase9a/PHASE9A_DOMAIN_CONTRACT.md 初稿，包含 glossary、9A non-goals、实体关系候选、现有能力复用清单、9B/9C/9D 边界、风险和需要确认的问题。同步在 docs/TODO.md 中只增加或调整 9A 规划引用，不把任何实现标成完成。
