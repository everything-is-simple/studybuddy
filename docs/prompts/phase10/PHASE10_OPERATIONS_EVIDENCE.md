...
- `docs/prompts/BACKUP_OPERATIONS.md`: retention, rotation, permissions, quarantine and failure isolation.
- `docs/prompts/OPERATOR_UPGRADE.md`: stop -> backup -> verify -> preflight -> startup -> acceptance procedure.
- `docs/prompts/RESTORE_DRILL.md`: offline/online drill template, task/attempt state checks, health/readiness/diagnostics, and incident stop conditions.
