...
| `/api/study/goals/{id}` | plans.html |
| `/api/study/goals/{id}/archive` | plans.html |
...
| `/api/study/modules/{id}` | plans.html |
| `/api/study/modules/{id}/archive` | plans.html |
...
| `/api/study/plans/{id}/dependencies/{id}` | plans.html |
